...
| comms-hub          | —                           | `PRESALE/alpina-comms-hub`                            | — (libs + MCP) | `alpina_comms` @ CT 211  | off since 2026-09-10 (D2)  | retired           |
| portal             | clients.alpina.solutions    | `PRESALE/alpina-portal`                               | 4728           | `alpina_portal` @ hetzner | Coolify hetzner (image)    | live              |
| ats                | recruitment.alpina-tech.org | `personal/ALPINA/alpina-recruiting` (ats/)            | 3000           | `recruitment` @ hetzner  | Coolify hetzner (image)    | live              |
...
| time (Kimai)       | time.alpina-tech.org        | vendor (Kimai)                                        | —              | own (mariadb)            | compose hetzner            | live              |
...
| hub                | hub.alpina-tech.org         | `PRODUCT/alpina-hub`                                  | 4421           | `hub` schema, Hetzner    | Coolify hetzner            | live              |
